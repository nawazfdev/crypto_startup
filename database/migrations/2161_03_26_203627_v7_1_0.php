...
class V710 extends Migration
{
    ...
    public function up()
    {
        if (Schema::hasTable('users')) {
            Schema::table('users', function (Blueprint $table) {
                ...
                if (!Schema::hasColumn('users', 'stripe_onboarding_verified')) {
    ...
    public function down()
    {
        ...
        // Check and drop foreign key separately
        if (Schema::hasColumn('users', 'country_id')) {
            ...
            if (!empty($foreignKeyExists)) {
                DB::statement('ALTER TABLE users DROP FOREIGN KEY users_country_id_foreign');
            }
