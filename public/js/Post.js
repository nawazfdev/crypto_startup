...
// Safety check for jQuery - more robust version
(function() {
    // Check if jQuery is not defined at all
    if (typeof jQuery === 'undefined') {
        console.error("jQuery is not available. Waiting for it to load...");
        // Try to add it if missing completely
    ...
    // Make $ alias available if jQuery is loaded but $ isn't
