                        ...
                        <div>
                            ...
                            <div class="d-flex text-left radio-group row px-2">
                                ...
                                @endif
                                    ...
                                    @endif
                                <div class="credit-payment-method p-1 col-6 col-md-3 col-lg-3 col-md-3" @if(!Auth::check() || !Auth::user()->wallet || Auth::user()->wallet->total <= 0) data-toggle="tooltip" data-placement="right" @endif title="{{__('You can use the wallet deposit page to add credit.')}}">
