<div class="side-menu px-1 px-md-2 px-lg-3">
    ...
    <ul class="nav flex-column user-side-menu">
        ...
        <li class="nav-item">
            <a href="{{ route('streams.index') }}" class="h-pill h-pill-primary nav-link {{Route::currentRouteName() == 'streams.index' ? 'active' : ''}} d-flex justify-content-between">
                <div class="d-flex justify-content-center align-items-center">
                    <div class="icon-wrapper d-flex justify-content-center align-items-center">
                        @include('elements.icon',['icon'=>'videocam-outline','variant'=>'large'])
                    </div>
                    <span class="d-none d-md-block d-xl-block d-lg-block ml-2 text-truncate side-menu-label">{{__('Livestreams')}}</span>
                </div>
            </a>
        </li>
        <li class="nav-item">
        ...
        @if(GenericHelper::isEmailEnforcedAndValidated())
            ...
            <li class="nav-item">
                <a href="{{route('cryptocurrency.index')}}" class="nav-link {{Route::currentRouteName() == 'cryptocurrency.index' || Route::currentRouteName() == 'cryptocurrency.wallet.index' ? 'active' : ''}} h-pill h-pill-primary d-flex justify-content-between">
                    <div class="d-flex justify-content-center align-items-center">
                        <div class="icon-wrapper d-flex justify-content-center align-items-center">
                            @include('elements.icon',['icon'=>'logo-bitcoin','variant'=>'large'])
                        </div>
                        <span class="d-none d-md-block d-xl-block d-lg-block ml-2 text-truncate side-menu-label">{{__('Tokens')}}</span>
                    </div>
                </a>
            </li>
            <li class="nav-item">
